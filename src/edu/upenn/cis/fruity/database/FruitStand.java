...
public class FruitStand {
	...
	public boolean addTotals(Context context, double cost, double revenue,
			double final_cash) {
		Totals totals = new Totals(id, cost, revenue, final_cash);
	...
	public boolean addPurchase(Context context, String item_name, int count,
			int num_coupons, int num_tradeins, double amount_cash,
			String customer) {
		Purchase purchase = new Purchase(id, item_name, count,
