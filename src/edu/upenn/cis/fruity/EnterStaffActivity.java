...
public class EnterStaffActivity extends Activity {
	...
	private boolean enterToDatabase() {
		DatabaseHandler dh = DatabaseHandler.getInstance(this);
		FruitStand stand = dh.getCurrentFruitStand();

		String volunteer1 = ((EditText) findViewById(R.id.enterStaff_volunteer1))
				.getText().toString();
		String volunteer2 = ((EditText) findViewById(R.id.enterStaff_volunteer2))
				.getText().toString();
		String volunteer3 = ((EditText) findViewById(R.id.enterStaff_volunteer3))
				.getText().toString();
		String volunteer4 = ((EditText) findViewById(R.id.enterStaff_volunteer4))
				.getText().toString();
		String staff1 = ((EditText) findViewById(R.id.enterStaff_staff1))
				.getText().toString();
		String staff2 = ((EditText) findViewById(R.id.enterStaff_staff2))
				.getText().toString();

		if (volunteer1.isEmpty() && volunteer2.isEmpty()
				&& volunteer3.isEmpty() && volunteer4.isEmpty()
				&& staff1.isEmpty() && staff2.isEmpty()) {
			Toast toast = Toast.makeText(getApplicationContext(),
					"Fill in at least one staff member to move on.",
					Toast.LENGTH_SHORT);
			toast.show();
			return false;
		}
